...
if ( ! class_exists( 'STATUS_Customizer' ) ) {
	class STATUS_Customizer {
		...
		public function __construct() {
			...
			add_action( 'customize_controls_print_styles', array( 'STATUS_Customizer', 'controls_print_styles' ) );

			// Register and unregister Customizer settings
			add_action( 'customize_register', array( 'STATUS_Customizer', 'customize_register' ) );
		...
		public static function get_prefix() {
			return apply_filters( 'st_customizer_prefix', 'st' );
		}
		...
		public static function get_panels() {
			return apply_filters( 'st_customizer_panels', null );
		}
				...
				foreach( $panel['sections'] as $section ) {
					...
					foreach ( $section['settings'] as $setting ) {
						...
						if ( isset( $setting['control']['object'] ) ) {
							...
							$control_object = 'STATUS_Customize_Control_Sorter';
						} elseif ( 'google_font' == $type ) {
							$control_object = 'STATUS_Fonts_Dropdown_Control';
						} elseif ( 'ui-slider' == $type ) {
							$control_object = 'STATUS_Customize_Sliderui_Control';
						} else {
							$control_object = false;
						}

						// Sanitize data based on input type
						if ( 'text' == $type || 'checkbox' == $type || 'select' == $type ) {
